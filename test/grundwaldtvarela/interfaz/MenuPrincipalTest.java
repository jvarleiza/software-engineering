...
public class MenuPrincipalTest {
    ...
    public void setUp() {
        ...
        Image resizedImage = menu.getImageIcon("/grundwaldtvarela/imagenes/playa_icono.png", boton);
    ...
    public void testCrearBotonera() {
        ...
        MenuPrincipal instance = new MenuPrincipal(null, true);
    ...
    public void testCrearBoton() {
        ...
        String rutaImagen = "/grundwaldtvarela/imagenes/playa_icono.png";
        int x = 10;
        int y = 30;
        String tipo = "Playas";
        MenuPrincipal instance = new MenuPrincipal(null, true);
