...
public class Informacion {
    public ArrayList<Actividad> cargarPlayas(ArrayList<Actividad> listaAct) {
        ...
        Actividad playaJI = new Actividad("Playa", "Playa Jose Ignacio",descripcionJI, null); 
        ...
        Actividad playaMansa = new Actividad("Playa", "Playa Mansa",desPlayaMansa, null);
        ...
        Actividad playaBrava = new Actividad("Playa", "Playa Brava",desPlayaBrava, null);
        ...
        Actividad playaMontoya = new Actividad("Playa", "Playa de la Barra",desPlayaMontoya, null);
        ...
        Actividad playaPostaDelCangrejo = new Actividad("Playa", "Playa de la Barra",desPlayaPostaDelCangrejo, null);
